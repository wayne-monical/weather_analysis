...
Aggregating instead by hour of the day, we see very similar activity levels across sex and education. Activity increases from the fifth hour to the tenth, where it gradually decreases until the twentieth hour, where it drops off steeply. This pattern is affirmed by humans' typically sleep cycle. 
...
```
Next we investigate the effect of day of the week, month, and year on median ride duration. 
```{r}
citi |> 
